...
| [[Session Notes — 2026-05-28 — Homelab Vault Backup & Pi-hole v6 API Migration]] | 2026-05-28 | Migrated notes repo to HTTPS and successfully backed up Obsidian vault and local automation scripts to GitHub. Diagnosed Pi-hole widget 'API Error: Bad request' (Pi-hole v6 REST API) and migrated services.yaml to version 6 with key placeholders. |
